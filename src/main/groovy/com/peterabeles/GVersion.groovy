...
//                println("  git version "+version_of_git[0]+"."+version_of_git[1]+"."+version_of_git[2])
                ...
                if (language == Language.JAVA) {
                    new File(gversion_file_path, extension.className + '.java').withWriter { writer ->
                        ...
                        writer << "${indent}@Log public static final String VERSION = \"${gitTag}\";\n"
                        writer << "${indent}@Log public static final int GIT_REVISION = $git_revision;\n"
                        writer << "${indent}@Log public static final String GIT_BRANCH = \"$git_branch\";\n"
